# R/04c_wr_asymmetric_conformal.R
...
readr::write_csv(results,   "output/04c_wr_asym_fold_predictions.csv")
readr::write_csv(pooled_wr, "output/04c_wr_asym_pooled_coverage.csv")
readr::write_csv(low_wr,    "output/04c_wr_asym_low_usage_coverage.csv")

cli_alert_success("output/04c_wr_asym_fold_predictions.csv ({nrow(results)} rows)")
cli_alert_success("output/04c_wr_asym_pooled_coverage.csv")
cli_alert_success("output/04c_wr_asym_low_usage_coverage.csv")

cli_h1("Step 4c complete")
