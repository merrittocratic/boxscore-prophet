# R/04c_wr_asymmetric_conformal_volfix.R
# Step 4c VOLFIX CLONE: WR asymmetric-conformal volume retrain with the
# baseline_* prior-season carryforward features (75e6b43) added to the
# volume model only.
#
...
readr::write_csv(results,   "output/04c_wr_asym_fold_predictions_volfix.csv")
readr::write_csv(pooled_wr, "output/04c_wr_asym_pooled_coverage_volfix.csv")
readr::write_csv(low_wr,    "output/04c_wr_asym_low_usage_coverage_volfix.csv")

cli_alert_success("output/04c_wr_asym_fold_predictions_volfix.csv ({nrow(results)} rows)")
cli_alert_success("output/04c_wr_asym_pooled_coverage_volfix.csv")
cli_alert_success("output/04c_wr_asym_low_usage_coverage_volfix.csv")
