...
# NA player_id excluded: the frozen WR table carries one NA-player
# pseudo-row per team-game (unattributed targets; wr_ids includes an NA
# gsis_id so `NA %in% wr_ids` passes the play filter). Flagged 2026-07-18
# as a data-quality item for the WR chain; a slate row must be a person.
roster <- if (hindcast) {
